...
export default function AuditLogsPage() {
    ...
    return (
        <div className="p-6 space-y-6">
            <PageHeader
                title="Logs d'Audit"
                description="Historique des actions sensibles effectuées dans le système"
            />
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    ...
                                    >
                                        ...
                                        {fromDate ? format(fromDate, "dd MMM yyyy", { locale: fr }) : "Sélectionner"}
                                    </Button>
                                </PopoverTrigger>
                        ...
                        <div className="min-w-[180px]">
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    ...
                                    >
                                        <CalendarIcon className="mr-2 h-4 w-4" />
                                        {toDate ? format(toDate, "dd MMM yyyy", { locale: fr }) : "Sélectionner"}
                                    </Button>
                                </PopoverTrigger>
                                <PopoverContent className="w-auto p-0">
                                    <Calendar
