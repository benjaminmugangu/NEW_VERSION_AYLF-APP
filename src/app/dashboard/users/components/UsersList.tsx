  ...
  const handleConfirmDelete = async () => {
    ...
    startTransition(async () => {
      ...
      if (response.ok) {
        ...
        toast({ title: 'Error', description: errorData.error || 'Failed to delete user.', variant: 'destructive' });
      }
    });
  };
      ...
      <AlertDialog open={!!userToDelete} onOpenChange={(isOpen) => !isOpen && setUserToDelete(null)}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleConfirmDelete} className="bg-destructive hover:bg-destructive/90" disabled={isPending}>
