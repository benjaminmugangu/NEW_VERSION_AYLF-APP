...
%=========================================================
\chapter{Degrees of Comparison and Exceptions}
%=========================================================
...
\begin{itemize}
  \item \textbf{Positive}: Describes a quality without comparison. \textit{He is tall.}
  \item \textbf{Comparative}: Compares two things. \textit{He is \textbf{taller} than Mike.}
  \item \textbf{Superlative}: Compares one thing to a whole group. \textit{He is the \textbf{tallest} in the class.}
\end{itemize}

\section{Formatting Rules}

The way we form the comparative and superlative depends on the length of the
word.

\subsection{Short Adjectives (1 Syllable)}
Add \textbf{-er} for comparative and \textbf{-est} for superlative.
\begin{itemize}
  \item Fast $\rightarrow$ fast\textbf{er} $\rightarrow$ the fast\textbf{est}
  \item Small $\rightarrow$ small\textbf{er} $\rightarrow$ the small\textbf{est}
  \item \textit{Note}: If the word ends in consonant-vowel-consonant, double the last letter: big $\rightarrow$ bi\textbf{gger}.
\end{itemize}

\subsection{Long Adjectives (2+ Syllables)}
Use \textbf{more} for comparative and \textbf{the most} for superlative.
\begin{itemize}
  \item Expensive $\rightarrow$ \textbf{more} expensive $\rightarrow$ \textbf{the most} expensive
  \item Intelligent $\rightarrow$ \textbf{more} intelligent $\rightarrow$ \textbf{the most} intelligent
\end{itemize}

\subsection{Adjectives ending in \enquote{-y}}
Change \enquote{y} to \enquote{i} and add \textbf{-er} or \textbf{-est}.
\begin{itemize}
  \item Happy $\rightarrow$ happ\textbf{ier} $\rightarrow$ the happ\textbf{iest}
  \item Busy $\rightarrow$ bus\textbf{ier} $\rightarrow$ the bus\textbf{iest}
\end{itemize}

\section{Irregular Adjectives (Exceptions)}

Some adjectives follow their own unique patterns and do not use the rules
above. These are critical to memorize.
...
\section{Repeated Comparison}

We use repeated comparison to show that something is continuously
increasing or decreasing.

\subsection{With Short Adjectives}
Pattern: \textbf{Adjective-er and Adjective-er}
\begin{itemize}
  \item \enquote{The weather is getting \textbf{colder and colder}.}
  \item \enquote{The runner went \textbf{faster and faster}.}
\end{itemize}

\subsection{With Long Adjectives}
Pattern: \textbf{More and more + Adjective}
\begin{itemize}
  \item \enquote{The exam is getting \textbf{more and more difficult}.}
  \item \enquote{Cities are becoming \textbf{more and more crowded}.}
\end{itemize}

\section{The Proportionate Comparison (The... the...)}

Also known as double comparatives, this structure shows how one thing
depends on another.

\begin{itemize}
  \item \enquote{\textbf{The more} you study, \textbf{the better} you become.}
  \item \enquote{\textbf{The sooner}, \textbf{the better}.}
\end{itemize}
